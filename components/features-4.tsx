    ...
    <section id="features" className="py-12 md:py-20">
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
        <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
          ...
          <p>
            Spectraverse provides a unified platform for developers and
            businesses to access local AI models running in Ollama, eliminating
            the need for external APIs while maintaining full control over their
            AI infrastructure.
          </p>
        </div>
